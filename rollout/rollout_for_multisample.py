...
d_array = np.array(Deltas) # 3-dimensional data!!! 
d_array_avgsess = d_array.mean(axis=0)
d_array_avgts = d_array.mean(axis=1)
d_array_avgagt = d_array.mean(axis=2)
...
import pandas as pd
deltas_avgsess_df = pd.DataFrame(d_array_avgsess)
deltas_avgts_df = pd.DataFrame(d_array_avgts)
deltas_avgagt_df = pd.DataFrame(d_array_avgagt)
deltas_avgsess_df.columns = ['Agent_0', 'Agent_1']
deltas_avgts_df.columns = ['Agent_0', 'Agent_1']

deltas_irf_df = pd.DataFrame(dirf_array)
deltas_irf_df.columns = ['Agent_0', 'Agent_1']

prices_irf_df = pd.DataFrame(obs_array)
prices_irf_df.columns = ['Agent_0', 'Agent_1']

# save dataframe to disk
j = 19
deltas_avgsess_df.to_csv('/home/lorenzo/Desktop/rollout_dfs/deltas_avgsess_df_'+str(j)+'.csv')
deltas_avgts_df.to_csv('/home/lorenzo/Desktop/rollout_dfs/deltas_avgts_df_'+str(j)+'.csv')
deltas_avgagt_df.to_csv('/home/lorenzo/Desktop/rollout_dfs/deltas_avgagt_df_'+str(j)+'.csv')
deltas_irf_df.to_csv('/home/lorenzo/Desktop/rollout_dfs/deltas_irf_df_'+str(j)+'.csv')
prices_irf_df.to_csv('/home/lorenzo/Desktop/rollout_dfs/prices_irf_df_'+str(j)+'.csv')
